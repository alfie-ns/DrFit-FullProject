...
from .views import GetFoodItem, CreateFoodDiaryEntry, GetCalorieSummary, GetFoodsEaten, GetFoodSearch, ManualCreateFoodDiaryEntry, GetMealPlan
...
urlpatterns = [
    ...
    path('get_meal_plan/', GetMealPlan.as_view(), name='get_meal_plan'),
]